	...
	<div id="templatemo_container">
		...
		<div id="templatemo_content_wrapper">
			<div id="templatemo_content">
				...
				<div class="header_01">Contato</div>

				<p>Àqueles alunos que tiverem dúvidas, procurem o Prof.
				Paulo Teixeira na Fatec</p>

				<p>Aos não alunos, o portal estará no ar em breve, bem 
				como o contato de seus responsáveis.</p>
				<p>&nbsp</p>
				<p>&nbsp</p>
				<p>&nbsp</p>
				<p>&nbsp</p>

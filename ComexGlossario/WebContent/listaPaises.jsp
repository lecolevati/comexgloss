		...
		<div id="templatemo_content_wrapper">
			<div id="templatemo_content">
				...
				<div class="column_w430 fl vl_divider">
					...
					<div class="header_01">Lista de Países</div>
					
					<table>
						<c:forEach items="${listaPaises}" var="pais">
							<tr>
								<td>
									 <a href="${pageContext.request.contextPath}/consultatermospais?pais=<c:out value="${pais.codigo}"/>" accesskey="1" title="" >
										${pais}<c:out value=" (Capital: " />${pais.capital}<c:out value=")" />
									</a>	
								</td>
							</tr>
						</c:forEach>

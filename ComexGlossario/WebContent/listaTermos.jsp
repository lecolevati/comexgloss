		...
		<div id="templatemo_content_wrapper">
			<div id="templatemo_content">
				...
				<div class="column_w430 fl vl_divider">
					...
					<div class="header_01"><c:out value="${nomePais}" /><c:out value=" (Capital: " /><c:out value="${capitalPais}" /><c:out value=")" /> </div>
						...
						<table border="2" align="center">
							<tr>
								<td style="font-style: italic;">
									<c:out value="${termo.assunto}" />
								</td>
							</tr>
							<tr>
								<td>
									<textarea rows="15" cols="42" readonly="readonly">
										<c:out value="${termo.texto}" />
									</textarea>
								</td>
							</tr>
							<tr>
								<td>
									<c:out value="Por :" /><c:out value="${termo.nomeAluno}" />
								</td>
							</tr>
						</table>
						<br />
